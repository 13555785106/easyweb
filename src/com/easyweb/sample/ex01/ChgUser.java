package com.easyweb.sample.ex01;
...
@WebServlet(name="sample.ex01.ChgUser",urlPatterns="/sample/ex01/ChgUser")
public class ChgUser extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		User user = UserDac.getInstance().getUser(Integer.parseInt(id));
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (reqErrors.size() > 0) {
			...
			User user = UserDac.getInstance().getUser(Integer.parseInt(request.getParameter("id")));

...
<body>
	<form method="post">
	 ...
	 -->
		<input type="hidden" name="fieldNotNeedTrim" value="[passwd],[confirmPasswd]" /> <input type="hidden" name="arraySeparator" value="," /> <input type="hidden" name="arrayFields" value="[hobbies]" /> <input type="hidden" name="id"
			value="${reqParams.id}" />
		<table align="center">

	 ...
	 -->
		...
		<table align="center">
			...
			<tr>
				<th>工资：</th>
				<td>
				<fmt:formatNumber value="${reqParams.salary}" var="salary" pattern="0.00"/>
				<input type="text" name="salary" value="${salary}" size="6" />
				</td>
